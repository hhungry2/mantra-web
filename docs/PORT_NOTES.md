...
**実装済み**の挙動について、原作Cソースのどこを根拠にしたかを記録する文書。
新しく実装した箇所は同じ書式でここに追記すること。

関連文書:

- [`HANDOFF_GAPS.md`](HANDOFF_GAPS.md) — 第1次の是正タスク（**完了・クローズ済み**）
- [`HANDOFF_GAPS_2.md`](HANDOFF_GAPS_2.md) — 第2次の残作業タスク H〜O（**未着手**）
